...
{
    switch (unit) {
    case Unit::BTC: return QString("ZET");
    case Unit::mBTC: return QString("mZET");
    case Unit::uBTC: return QString::fromUtf8("µZET (bits)");
    case Unit::SAT: return QString("Zatoshi (zat)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Zetacoins");
    case Unit::mBTC: return QString("Milli-Zetacoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Zetacoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Zatoshi (zat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
