...
# Extract options
function __fish_zetacoin_tx_get_options
...
# Extract commands
function __fish_zetacoin_tx_get_commands
...
complete \
    --command zetacoin-tx \
    --condition "not __fish_zetacoin_seen_cmd (__fish_zetacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_zetacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command zetacoin-tx \
    --arguments "(__fish_zetacoin_tx_get_commands)" \
    --no-files
