...
complete --command zetacoind --no-files

# Extract options
function __fish_zetacoind_get_options
...
complete \
    --command zetacoind \
    --arguments "(__fish_zetacoind_get_options --nofiles)"
